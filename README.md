...
-  **[NetMap](https://github.com/MeidadShemesh/NetMap)** — C# WinForms network device manager built on a polymorphic class hierarchy (abstract base → Computer → Laptop / Server, plus Router), with a drag-and-drop GDI+ canvas, full CRUD, event-driven UI, and save/load via serialization. OOP course final project. (currently private)
